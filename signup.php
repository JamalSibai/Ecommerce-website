    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          ...
          ?>
          <form class="text-left clearfix" id="signupForm" action="php/signup.php" method="POST">
            ...
            <div class="form-group">
              <input type="text" class="form-control" required  placeholder="Phone Number" name="phone_number" id="phone_number">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <input type="password" class="form-control" required  placeholder="Confirm Password" name="confirmpass" id="confirmpass">
            </div>
            <div class="form-group">
              <select class="form-control" required  name="usertype" placeholder="usertype" id = "type" >
                <option class="form-control" value="buyer"> Buyer </option>
                <option class="form-control"value="seller"> Seller </option>
              </select>
            </div>
            <div class="text-center">
              <button type="submit" class="btn btn-main text-center "  id = "signup">Signup</button>
            </div>
          </form>
